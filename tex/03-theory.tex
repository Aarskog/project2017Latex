...
\end{lstlisting}
Below in \lstref{lst:matlabPubl} one can see how the publishers are created which will publish the desired joint torques calculated by the multivariable controller to the joint controllers.
...
\end{lstlisting}
\end{comment}
How to publish the wanted torques is seen below in \lstref{lst:matlabPubs}. Here $u$ is the vector of the controller output. 
