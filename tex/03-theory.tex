...
Now that we know that the gravity compensation is working one can start to test the controller. The gain matrices $K_p$ and $K_d$ are implemented as positive definite diagonal matrices.
...
\subsection{More improvements that should be included}
